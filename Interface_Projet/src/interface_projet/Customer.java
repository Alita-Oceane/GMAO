...
public class Customer extends JFrame {
	...
	public Customer() {
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//Afficher page de DEMANDE DE MAINTENANCE
		...
		lblCustomer.setBounds(243, 10, 88, 38);
		desktopPane_1.add(lblCustomer);
		...
		btnNewButton_4.setBounds(252, 79, 269, 44);
		...
		btnNewButton_4_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				CustomerList secondFrame = new CustomerList();
                secondFrame.setVisible(true);
			}
		});
		btnNewButton_4_1.setBackground(SystemColor.activeCaptionBorder);
		btnNewButton_4_1.setBounds(518, 79, 260, 44);
		...
		textField.setBounds(429, 159, 225, 19);
		contentPane_1.add(textField);
		
		JLabel lblNewLabel_1 = new JLabel("Society");
		lblNewLabel_1.setBounds(373, 158, 46, 21);
		contentPane_1.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("IFU");
		lblNewLabel_2.setBounds(373, 202, 34, 21);
		contentPane_1.add(lblNewLabel_2);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(429, 203, 225, 19);
		contentPane_1.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(429, 246, 225, 19);
		contentPane_1.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(429, 291, 225, 19);
		contentPane_1.add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(429, 338, 225, 19);
		contentPane_1.add(textField_4);
		
		JLabel lblNewLabel_1_1 = new JLabel("RCCM");
		lblNewLabel_1_1.setBounds(373, 245, 46, 21);
		contentPane_1.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_1_2 = new JLabel("Adress");
		lblNewLabel_1_2.setBounds(373, 290, 46, 21);
		contentPane_1.add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_1_3 = new JLabel("APE code");
		lblNewLabel_1_3.setBounds(373, 337, 61, 21);
